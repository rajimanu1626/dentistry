...
export const patientsApi = {
	...
	create: (body: PatientCreate) =>
		apiClient.post<PatientPublic>("/patients", body),
	...
	visitSummary: (visitId: string) =>
		apiClient.get<VisitSummary>(`/visits/${visitId}/summary`),
	createVisit: (body: VisitCreatePayload) =>
		apiClient.post<{ id: string }>("/visits", body),
	...
	uploadMedia: (
		...
		return apiClient.post<PatientMediaItem>(
	...
	createExternalShare: (patientId: string, body: ExternalShareCreatePayload) =>
		apiClient.post<ExternalShareCreated>(
			`/patients/${patientId}/external-shares`,
			body,
		),
	listExternalShares: (patientId: string) =>
		apiClient.get<ExternalShareRecord[]>(
			`/patients/${patientId}/external-shares`,
		),
