			...
			<section className="card space-y-3">
				...
				{!meQuery.isLoading && !currentMembership && (
					<p className="text-sm text-red-600">
						No clinic selected. Sign out and sign in again to restore clinic
						context.
					</p>
				)}
				{currentMembership && (
			...
			<section className="card space-y-4">
				<header>
					...
					<p className="mt-1 text-xs text-slate-500">
						Invite dentists, receptionists, and staff. Invite links are one-time
						use.
					</p>
				</header>
				{!clinicId && (
