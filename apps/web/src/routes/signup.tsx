...
function SignupPage() {
	...
	const canSubmit = useMemo(() => {
		...
		if (showClinicFields && (!clinicName.trim() || !clinicSlug.trim()))
			return false;
		return true;
		...
		return (
			<div className="card mx-auto max-w-md space-y-3 text-center">
				...
				<p className="text-sm text-slate-600">
					New accounts are invite-only. Contact your clinic administrator for
					access.
				</p>
			...
			>
				...
				{requiresInvite && (
					<label className="field">
						<span>
							Invite token (optional if you already have access)
						</span>
						<input
							type="text"
